...
function updateTranslationsMulti(key, endpoint, location, fromLang, toLangs, jsonFile, folderNamePath = "multiFolderGeneratedTranslations") {
    ...
    async function translateAndSaveAll() {
        const translationPromises = toLangs.map(async (lang) => {
            ...
            if (fs.existsSync(outputFileName)) {
                ...
                return await (0, translateToMultipleFolders_1.default)(key, endpoint, location, fromLang, [lang], jsonFile, folderNamePath);
            }
