...
function translateToMultipleFolders(key, endpoint, location, fromLang, toLangs, jsonFile, folderNamePath = "multiFolderGeneratedTranslations") {
    ...
    async function translateAndSave(lang) {
        ...
        const translations = await (0, translate_1.default)(key, endpoint, location, fromLang, [lang], jsonFile);
    ...
    async function translateAndSaveAll() {
        const translationPromises = toLangs.map(async (lang) => await translateAndSave(lang));
